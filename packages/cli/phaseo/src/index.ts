...
const HELP_ENTRIES: Record<string, HelpEntry> = {
	...
	integrations: {
		...
		usage: [
			"phaseo integrations list [codex|claude-code] [--json]",
	...
	"integrations list": { usage: ["phaseo integrations list [codex|claude-code] [--json]"] },
	"integrations status": { usage: ["phaseo integrations status [codex|claude-code] [--json]"] },
	"integrations setup": { usage: ["phaseo integrations setup codex [--model <id>] [--dry-run] [--json]", "phaseo integrations setup claude-code [--dry-run] [--json]"] },
	"integrations remove": { usage: ["phaseo integrations remove <codex|claude-code> [--dry-run] [--json]"] },
