...
public static class Operations
{
	...
	{
		var resolvedPath = "/guardrails/" + (path != null && path.ContainsKey("id") ? path["id"] : "") + "/keys/add";
	...
	{
		var resolvedPath = "/guardrails/" + (path != null && path.ContainsKey("id") ? path["id"] : "") + "/members/add";
		return client.SendAsync<Dictionary<string, object>>("POST", resolvedPath, query, headers, body);
	}
	...
	{
		var resolvedPath = "/guardrails/" + (path != null && path.ContainsKey("id") ? path["id"] : "");
		return client.SendAsync<Dictionary<string, object>>("DELETE", resolvedPath, query, headers, body);
	}
	...
	{
		var resolvedPath = "/guardrails/" + (path != null && path.ContainsKey("id") ? path["id"] : "") + "/keys";
		return client.SendAsync<Dictionary<string, object>>("GET", resolvedPath, query, headers, body);
	}
	...
	{
		var resolvedPath = "/guardrails/" + (path != null && path.ContainsKey("id") ? path["id"] : "") + "/members";
		return client.SendAsync<Dictionary<string, object>>("GET", resolvedPath, query, headers, body);
	}
	...
	{
		var resolvedPath = "/guardrails/" + (path != null && path.ContainsKey("id") ? path["id"] : "") + "/keys/remove";
		return client.SendAsync<Dictionary<string, object>>("POST", resolvedPath, query, headers, body);
	}
	...
	{
		var resolvedPath = "/guardrails/" + (path != null && path.ContainsKey("id") ? path["id"] : "") + "/members/remove";
		return client.SendAsync<Dictionary<string, object>>("POST", resolvedPath, query, headers, body);
	}
