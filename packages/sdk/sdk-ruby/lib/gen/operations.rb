  ...
  module Gen
    module Operations
      ...
      def self.cancelBatch(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batches/#{URI.encode_www_form_component(path["batch_id"].to_s)}/cancel"
        client.request(method: "POST", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.cancelBatchAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batch/#{URI.encode_www_form_component(path["id"].to_s)}/cancel"
        client.request(method: "POST", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.cancelVideo(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/videos/#{URI.encode_www_form_component(path["video_id"].to_s)}/cancel"
        client.request(method: "POST", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.cancelVideoAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/video/generations/#{URI.encode_www_form_component(path["video_id"].to_s)}/cancel"
        client.request(method: "POST", path: resolved_path, query: query, headers: headers, body: body)
      end
      ...
      def self.createVideoDownloadUrl(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/videos/#{URI.encode_www_form_component(path["video_id"].to_s)}/download_url"
        client.request(method: "POST", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.createVideoDownloadUrlAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/video/generations/#{URI.encode_www_form_component(path["video_id"].to_s)}/download_url"
        client.request(method: "POST", path: resolved_path, query: query, headers: headers, body: body)
      end
      ...
      def self.deleteApiKey(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/keys/#{URI.encode_www_form_component(path["id"].to_s)}"
      ...
      def self.deleteVideo(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/videos/#{URI.encode_www_form_component(path["video_id"].to_s)}"
        client.request(method: "DELETE", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.deleteVideoAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/video/generations/#{URI.encode_www_form_component(path["video_id"].to_s)}"
        client.request(method: "DELETE", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.deleteWorkspace(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/workspaces/#{URI.encode_www_form_component(path["id"].to_s)}"
        client.request(method: "DELETE", path: resolved_path, query: query, headers: headers, body: body)
      end
      ...
      def self.getMusicGeneration(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/music/generate/#{URI.encode_www_form_component(path["music_id"].to_s)}"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.getMusicGenerationAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/music/generations/#{URI.encode_www_form_component(path["music_id"].to_s)}"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.getProviderDerankStatus(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/health/providers/#{URI.encode_www_form_component(path["provider_id"].to_s)}/derank"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end
      ...
      def self.getVideoContent(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/videos/#{URI.encode_www_form_component(path["video_id"].to_s)}/content"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.getVideoContentAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/video/generations/#{URI.encode_www_form_component(path["video_id"].to_s)}/content"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end
      ...
      def self.listBatchRequests(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batches/#{URI.encode_www_form_component(path["batch_id"].to_s)}/requests"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.listBatchRequestsAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batch/#{URI.encode_www_form_component(path["id"].to_s)}/requests"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end
      ...
      def self.listModelEndpoints(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/models/#{URI.encode_www_form_component(path["author"].to_s)}/#{URI.encode_www_form_component(path["slug"].to_s)}/endpoints"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end
      ...
      def self.openAsyncJobWebSocket(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/async/#{URI.encode_www_form_component(path["kind"].to_s)}/#{URI.encode_www_form_component(path["id"].to_s)}/ws"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.retrieveBatch(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batches/#{URI.encode_www_form_component(path["batch_id"].to_s)}"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.retrieveBatchAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batch/#{URI.encode_www_form_component(path["id"].to_s)}"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.retrieveBatchFile(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batches/files/#{URI.encode_www_form_component(path["file_id"].to_s)}"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.retrieveBatchFileAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batch/files/#{URI.encode_www_form_component(path["file_id"].to_s)}"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.retrieveBatchFileContent(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batches/files/#{URI.encode_www_form_component(path["file_id"].to_s)}/content"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.retrieveBatchFileContentAlias(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/batch/files/#{URI.encode_www_form_component(path["file_id"].to_s)}/content"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.retrieveFile(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/files/#{URI.encode_www_form_component(path["file_id"].to_s)}"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end

      def self.retrieveFileContent(client, path: nil, query: nil, headers: nil, body: nil)
        path ||= {}
        resolved_path = "/files/#{URI.encode_www_form_component(path["file_id"].to_s)}/content"
        client.request(method: "GET", path: resolved_path, query: query, headers: headers, body: body)
      end
