...
class ApiKey(TypedDict):
	...
	limit_remaining: NotRequired[Optional[float]]
	limit_reset: NotRequired[Optional[Literal["daily", "weekly", "monthly"]]]
	limits: NotRequired[ApiKeyLimitWindows]
	name: Optional[str]
	prefix: Optional[str]
