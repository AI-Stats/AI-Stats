...
pub struct GuardrailCreateRequest {
	...
	pub name: String,
	pub privacyEnableFreeMayPublishPrompts: Option<bool>,
	pub privacyEnableFreeMayTrain: Option<bool>,
	pub privacyEnableInputOutputLogging: Option<bool>,
	pub privacyEnablePaidMayTrain: Option<bool>,
	pub privacyZdrOnly: Option<bool>,
...
pub struct GuardrailRemovalResponse {
...
pub struct GuardrailWriteFields {
	pub allowedApiModelIds: Option<Vec<String>>,
	pub budgets: Option<HashMap<String, String>>,
	pub description: Option<Option<String>>,
	pub enabled: Option<bool>,
