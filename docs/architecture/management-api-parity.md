...
| Organisation administration | Workspace-native membership, invitations, SSO, and SCIM endpoint/token administration | Contracted for current workspace identity controls | Add department and group-mapping operations in the enterprise-directory slice. |
