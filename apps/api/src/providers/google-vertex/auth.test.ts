...
describe("google-vertex auth helpers", () => {
	...
	it("uses the provider adapter location instead of a shared location binding", () => {
		expect(resolveVertexApiBase({ GOOGLE_VERTEX_PROJECT: "project-1" }, "google-vertex")).toBe(
			"https://aiplatform.googleapis.com/v1/projects/project-1/locations/global",
		);
