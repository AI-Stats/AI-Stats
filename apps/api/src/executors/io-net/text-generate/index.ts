// Purpose: Executor for io-net / text-generate.
// Why: Keeps IO.NET's OpenAI-compatible gateway route provider-local.
// How: Uses the shared OpenAI wire executor and standard IR parameter handling.
