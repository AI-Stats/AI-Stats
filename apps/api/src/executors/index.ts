...
export const EXECUTORS_BY_PROVIDER: Record<string, ProviderCapabilityMap> = {
	...
	mistral: { "text.generate": mistralText, embeddings: openaiEmbeddings, moderations: openaiModerations, ocr: nonTextAdapterExecutor, "audio.transcription": nonTextAdapterExecutor },
	...
	"google-vertex-us": { "text.generate": googleVertexText, "video.generate": googleVertexVideo },
