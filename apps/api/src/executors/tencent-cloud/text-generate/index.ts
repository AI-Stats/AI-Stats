// Purpose: Executor for Tencent Cloud TokenHub text generation.
// Why: TokenHub exposes an OpenAI-compatible Chat Completions surface.
// How: Reuses the shared OpenAI wire transport while keeping provider policy explicit.
