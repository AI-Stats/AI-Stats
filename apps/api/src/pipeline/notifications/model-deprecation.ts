...
export function renderModelDeprecationEmail(
	...
	const content = getModelDeprecationContent(payload, now);
	const links = [
		content.comparisonUrl ? `<a href="${escapeHtml(content.comparisonUrl)}" style="display:inline-block;margin-right:12px;font-size:13px;line-height:20px;color:#0369a1;text-decoration:underline;font-weight:600;">Compare models</a>` : "",
		content.replacementModelUrl ? `<a href="${escapeHtml(content.replacementModelUrl)}" style="display:inline-block;font-size:13px;line-height:20px;color:#0369a1;text-decoration:underline;font-weight:600;">View recommended model</a>` : "",
	].filter(Boolean).join("");
...
<body style="margin:0;background-color:#ffffff;font-family:Arial,Helvetica,sans-serif;color:#18181b;">
	<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;background-color:#ffffff;"><tr><td align="center" style="padding-top:40px;padding-right:20px;padding-bottom:40px;padding-left:20px;">
		<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;max-width:600px;background-color:#ffffff;"><tr><td style="font-family:Arial,Helvetica,sans-serif;color:#18181b;">
			...
			<h1 align="center" style="margin-top:0;margin-right:0;margin-bottom:18px;margin-left:0;font-size:30px;line-height:36px;letter-spacing:-.02em;color:#09090b;font-weight:500;">${escapeHtml(content.title)}</h1>
			<p style="margin-top:0;margin-right:0;margin-bottom:26px;margin-left:0;font-size:16px;line-height:26px;color:#3f3f46;font-weight:400;">${escapeHtml(content.message)}</p>
			<p style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:13px;line-height:20px;color:#52525b;font-weight:400;">${links}</p>
		...
		<tr><td align="center" style="padding-top:40px;padding-right:20px;padding-bottom:40px;padding-left:20px;">
			<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;max-width:600px;background-color:#ffffff;">
				<tr><td style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;font-family:Arial,Helvetica,sans-serif;color:#18181b;">
					...
					<h1 align="center" style="margin-top:0;margin-right:0;margin-bottom:18px;margin-left:0;font-size:30px;line-height:36px;letter-spacing:-.02em;color:#09090b;font-weight:500;">Your destination is connected</h1>
