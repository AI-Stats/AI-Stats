...
| Meta Model API (`meta`, `meta-contributor`) | text.generate | fixed | [Model API](https://developer.meta.com/ai/products/meta-model-api/), [developer docs](https://dev.meta.ai/docs), [Muse Spark announcement](https://ai.meta.com/blog/introducing-muse-spark-meta-model-api/) |
