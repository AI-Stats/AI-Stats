...
const OPENAI_PARAMETER_EXPECTATIONS = {
	background: { outcome: "forwarded", requestValue: "opaque", upstreamPaths: ["background"] },
	...
	dimensions: { outcome: "forwarded", requestValue: 256, upstreamPaths: ["dimensions"] },
    duration: { outcome: "transformed", requestValue: 4, upstreamPaths: ["seconds"] },
	encoding_format: { outcome: "forwarded", requestValue: "float", upstreamPaths: ["encoding_format"] },
	...
	image: { outcome: "forwarded", requestValue: "https://example.test/image.png", upstreamPaths: ["image"] },
    input: { outcome: "forwarded", requestValue: "mock input", upstreamPaths: ["input"] },
	input_fidelity: { outcome: "forwarded", requestValue: "high", upstreamPaths: ["input_fidelity"] },
    input_image: { outcome: "transformed", requestValue: "https://example.test/input.png", upstreamPaths: ["input_reference"] },
	input_reference: { outcome: "forwarded", requestValue: "https://example.test/input.png", upstreamPaths: ["input_reference"] },
    input_video: { outcome: "transformed", requestValue: "https://example.test/input.mp4", upstreamPaths: ["input_reference"] },
	instructions: { outcome: "forwarded", requestValue: "Speak clearly.", upstreamPaths: ["instructions"] },
	...
	mask: { outcome: "forwarded", requestValue: "https://example.test/mask.png", upstreamPaths: ["mask"] },
    max_tokens: { outcome: "transformed", requestValue: 32, upstreamPaths: ["max_output_tokens", "max_completion_tokens"] },
	moderation: { outcome: "forwarded", requestValue: "auto", upstreamPaths: ["moderation"] },
	n: { outcome: "forwarded", requestValue: 1, upstreamPaths: ["n"] },
	output_compression: { outcome: "forwarded", requestValue: 90, upstreamPaths: ["output_compression"] },
	output_format: { outcome: "forwarded", requestValue: "png", upstreamPaths: ["output_format"] },
	partial_images: { outcome: "forwarded", requestValue: 1, upstreamPaths: ["partial_images"] },
	...
	quality: { outcome: "forwarded", requestValue: "medium", upstreamPaths: ["quality"] },
    reasoning: { outcome: "transformed", requestValue: { effort: "medium" }, upstreamPaths: ["reasoning.effort", "reasoning_effort"] },
	"reasoning.context": { outcome: "forwarded", requestValue: "all_turns", upstreamPaths: ["reasoning.context"] },
	...
	speed: { outcome: "forwarded", requestValue: 1, upstreamPaths: ["speed"] },
    stop: { outcome: "forwarded", requestValue: ["STOP"], upstreamPaths: ["stop"] },
	stream: { outcome: "forwarded", requestValue: false, upstreamPaths: ["stream"] },
	stream_format: { outcome: "forwarded", requestValue: "sse", upstreamPaths: ["stream_format"] },
	...
	user: { outcome: "forwarded", requestValue: "user-123", upstreamPaths: ["user"] },
	voice: { outcome: "forwarded", requestValue: "alloy", upstreamPaths: ["voice"] },
