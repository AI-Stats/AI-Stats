...
const SUPPORTED_SCOPES = new Set([
	...
	"settings:read", "guardrails:read", "budgets:read", "management_keys:read", "oauth_clients:read",
	"workspaces:write", "keys:write", "presets:write", "settings:write",
	"guardrails:write", "budgets:write", "management_keys:write", "oauth_clients:write",
	"workspaces:delete", "keys:delete", "presets:delete", "guardrails:delete", "budgets:delete",
