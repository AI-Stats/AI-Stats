...
export const CONTROL_SCOPES = [
	...
	"guardrails:read", "guardrails:write", "guardrails:delete", "budgets:read", "budgets:write", "budgets:delete", "management_keys:read", "management_keys:write", "management_keys:delete",
