...
const sectionIcons: Record<string, LucideIcon> = {
	...
	"token-usage": PieChart,
	"top-models": Trophy,
	"top-apps": AppWindow,
	overview: Info,
	"latest-releases": Bolt,
	organisations: Landmark,
	links: Link2,
	"latest-models": Package,
	summary: ScrollText,
	progress: Activity,
	"model-results": Trophy,
	"family-detail-primary-header": Info,
	"family-members": Package,
	"main-features": Wrench,
	"included-models": Package,
	usage: Activity,
	"model-leaderboard": Trophy,
	models: MapPinned,
	text: Trophy,
	"fastest-models": Gauge,
	"usage-signals": Activity,
	"context-length": FileText,
	"image-inputs": ImagePlus,
	geography: Globe2,
};
