		...
		<main className="min-h-screen bg-background">
			<div className="mx-auto w-full max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
				<Link href="/trust" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
					<ArrowLeft className="size-4" /> Trust Centre
				</Link>
				<header className="mt-8 border-b border-border pb-8">
					<div className="flex items-center gap-2 text-sm font-medium"><ShieldCheck className="size-4" /> Phaseo Trust Centre</div>
					...
					<div className="mt-5 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
						...
						<span>Last reviewed {trustLastReviewed.display}</span>
					</div>
				</header>
				...
				<footer className="mt-16 flex flex-wrap items-center justify-between gap-4 border-t border-border pt-6 text-xs text-muted-foreground">
					<div className="flex flex-wrap gap-x-5 gap-y-2">
						<Link href="/trust" className="hover:text-foreground">Trust Centre</Link>
						<Link href="/privacy" className="hover:text-foreground">Privacy Policy</Link>
						<Link href="/terms" className="hover:text-foreground">Terms of Service</Link>
					</div>
					<a href="mailto:privacy@phaseo.app" className="inline-flex items-center gap-1 hover:text-foreground">Privacy questions <ArrowUpRight className="size-3.5" /></a>
				</footer>
			</div>
		</main>
	);
