...
import {
	...
	getLocalizedHelpArticle,
	getLocalizedHelpCategory,
...
export default async function HelpArticlePage({ params }: PageProps) {
	...
	const [article, categoryData, t] = await Promise.all([
		getLocalizedHelpArticle(locale, category, slug),
		getLocalizedHelpCategory(locale, category),
	...
	return (
		<div className="container mx-auto w-full max-w-6xl px-4 py-8 md:py-12">
			...
			<div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
				...
				<aside>
					<Card className="p-5">
						<h2 className="text-base font-semibold">{t("moreIn", { category: categoryData.title })}</h2>
