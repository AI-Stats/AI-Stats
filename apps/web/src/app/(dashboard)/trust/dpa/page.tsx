	...
	return (
		...
		>
			<TrustCallout title="Review draft">
				This draft is written to cover the mandatory controller-processor terms in Article 28 of the UK GDPR and EU GDPR. It still needs Phaseo's service address, confirmed vendor locations and transfer terms, a complete list of Phaseo-managed AI Subprocessors, a verified backup-retention period, an operational 30-day subprocessor-notice process, and qualified legal approval. Request an execution copy from <a href="mailto:privacy@phaseo.app" className="text-foreground underline underline-offset-4">privacy@phaseo.app</a>.
			</TrustCallout>
			...
			<TrustSection id="deletion" title="9. Return and deletion">
				<ol className={clauses}>
					...
					<li>Phaseo will complete deletion from active systems within 30 days after the applicable instruction or termination date. Copies in backups will remain protected and isolated from ordinary use until deleted through the backup cycle.</li>
					<li className={reviewText}>Before execution, Phaseo must confirm the maximum backup-retention period and its operational ability to meet the 30-day active-system deletion commitment.</li>
