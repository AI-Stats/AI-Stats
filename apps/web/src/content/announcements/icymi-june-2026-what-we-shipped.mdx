...
The monitor history feed was rebuilt, monitor cards were polished, and status dates and links became more visible. Settings observability was also upgraded, and the gateway gained more API routes and usage metrics.
