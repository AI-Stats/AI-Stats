...
-   `client.batches.streamResults(batchId, { signal })` for streaming Anthropic JSONL downloads; see [batch results](/v1/guides/async-video-and-batch#download-anthropic-results)
