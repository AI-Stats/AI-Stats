...
The v5 line supports text generation and streaming, tools, structured output, embeddings, and image generation. Standardized reranking requires the current AI SDK 7 provider contract.
