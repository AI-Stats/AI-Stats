...
Video requests reference a workspace-managed webhook endpoint. Configure its URL and signing secret in Webhook settings so they can be rotated without changing requests:
