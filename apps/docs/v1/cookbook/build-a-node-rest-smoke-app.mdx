...
**Goal:** Verify Phaseo health, model discovery, and one generation request using raw HTTP.

**Outcome:** A dependency-light script you can keep as a deployment or integration smoke test.
