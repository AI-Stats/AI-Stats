...
**Goal:** Run a browser chat app that discovers models and sends responses through server-side routes.

**Outcome:** A working local chat interface with no Phaseo credentials exposed to the browser.
