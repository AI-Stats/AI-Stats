...
Use `GET /v1/batches/capabilities` before selecting an advanced endpoint and
...
- [Webhooks and job updates](../api-reference/async-lifecycle-updates.mdx)
