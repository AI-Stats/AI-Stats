...
<Card title="Standard Plan" icon="tag">
  **5% credit purchase fee**
  ...
  All workspaces use the same standard pay-as-you-go pricing. Phaseo does not use a separate enterprise plan for feature access.
</Card>
...
<AccordionGroup>
  ...
  <Accordion title="Is there an enterprise plan?">
    No. All workspaces use the same standard pay-as-you-go pricing. Product features are not reserved for a separate enterprise tier.
  </Accordion>

  <Accordion title="Can I request custom commercial terms?">
    Yes. For invoicing, procurement, or bespoke commercial requirements, contact sales. Custom commercial terms are not required to access product features.
  </Accordion>
</AccordionGroup>
