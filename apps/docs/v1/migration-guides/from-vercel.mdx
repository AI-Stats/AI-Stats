...
| API key | Vercel AI Gateway key | `PHASEO_API_KEY` |
| AI SDK provider | Existing provider setup | `@phaseo/ai-sdk-provider` when using the AI SDK directly |
| Application flow | Existing generation logic | Keep unchanged for the first migration pass |
