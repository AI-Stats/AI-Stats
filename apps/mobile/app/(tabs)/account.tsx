import { BookOpen, CreditCard, KeyRound, LockKeyhole, LogOut, Palette, Shield, UserRound, UsersRound, WalletCards } from "lucide-react-native";
...
export default function AccountScreen() {
  const { session, signOut } = useAuth(); const router = useRouter(); const p = usePalette(); const [key, setKey] = useState("");
