...
- Logo upload: `apps/web/public/png_logo_light.png` (1024 x 1024 PNG,
  black background with a white Phaseo mark)

Upload this file in the portal's **Info → Logo** field. The production MCP
server also advertises `https://phaseo.app/png_logo_light.png` in its standard
MCP server metadata, but that URL does not replace the portal upload for the
public listing.
